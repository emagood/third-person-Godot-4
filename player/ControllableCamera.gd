...
@onready var _camera: Camera3D = $GimbalH/GimbalV/SpringArm3D/Camera3D
@onready var _sprint: SpringArm3D = $GimbalH/GimbalV/SpringArm3D
...
func _physics_process(delta):
	...
	_sprint.spring_length = lerpf(_camera.transform.origin.z, _distance, zoom_speed * delta)
